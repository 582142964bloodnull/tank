...
public class MapCreator : MonoBehaviour {
    ...
    // 0：老家 1: 墙 2：障碍 3：敌人4:河流 5:丛林 6: 空气墙
    public GameObject[] mapItem;//模型
    ...
    private void Awake()
    {
        ...
        // 创建敌人
        InvokeRepeating("CreateEnemy", 1, 5);//每5秒创建一个敌人
    }
    ...
    private void CreateEnemy()//创建敌人
    {
        int Idx = Random.Range(0, 3);//三个随机数
